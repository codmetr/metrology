...
namespace KipTM.ViewModel.Checks.Config
{
    ...
    /// </para>
    /// </summary>
    public class CheckConfig1ViewModel : ViewModelBase
    {
        ...
        /// </summary>
        public CheckConfig1ViewModel(CheckConfigDevice model, IChannelsFactory channelFactory, CustomConfigFactory customConfigFactory)
        {
            _model = model;
