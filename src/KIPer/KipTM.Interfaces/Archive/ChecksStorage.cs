...
namespace KipTM.Archive
{
    public class ChecksStorage
    {
        ...
        private ChecksStorage(ArchiveBase archive, Dictionary<string, CheckData> checks)
        {
            _archive = archive;
            _checks = checks;
        }

        public static ChecksStorage Load(ArchiveBase archive)
        {
            ...
            return new ChecksStorage(archive, checks);
        }
